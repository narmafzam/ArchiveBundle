...
{
    /**
     * @ORM\ManyToOne(targetEntity="ArchiveBundle\Entity\ContractLineKind", inversedBy="children")
     */
    protected $parent;

    /**
     * @ORM\OneToMany(targetEntity="ArchiveBundle\Entity\ContractLineKind",mappedBy="parent", cascade={"persist", "remove"})
     */
    protected $children;

    /**
     * @ORM\OneToMany(targetEntity="ArchiveBundle\Entity\ContractLine", mappedBy="kind")
     */
    protected $lines;

    /**
     * @ORM\OneToMany(targetEntity="ArchiveBundle\Entity\ContractCommonLine", mappedBy="kind")
     */
