...
use Narmafzam\ArchiveBundle\ViewModel\Front\Document\DocumentEdit;
use Narmafzam\ArchiveBundle\ViewModel\Front\Document\DocumentIndex;
use Narmafzam\ArchiveBundle\ViewModel\Front\Document\DocumentNew;
use Narmafzam\ArchiveBundle\ViewModel\Front\Document\DocumentShow;
...
{
    const ROUTE__DOCUMENT_INDEX  = 'front_document_index';
    const ROUTE__DOCUMENT_SHOW   = 'front_document_show';
    const ROUTE__DOCUMENT_NEW    = 'front_document_new';
    const ROUTE__DOCUMENT_EDIT   = 'front_document_edit';
    const ROUTE__DOCUMENT_DELETE = 'front_document_delete';

    /**
     * @Route("", name = Narmafzam\ArchiveBundle\Controller\Front\DocumentController::ROUTE__DOCUMENT_INDEX)
     * @Method("GET")
     */
     ...
     *
     * @Route("/new", name = Narmafzam\ArchiveBundle\Controller\Front\DocumentController::ROUTE__DOCUMENT_NEW)
     * @Method({"GET", "POST"})
     */
     ...
     * @return Response A Response instance
     *
     * @Route("/{id}/edit", name = Narmafzam\ArchiveBundle\Controller\Front\DocumentController::ROUTE__DOCUMENT_EDIT)
     * @Method({"GET", "POST"})
     */
    ...
    /**
     * @Route("/{id}", name = Narmafzam\ArchiveBundle\Controller\Front\DocumentController::ROUTE__DOCUMENT_DELETE)
     * @Method("DELETE")
     */
