...
use Narmafzam\ArchiveBundle\ViewModel\Back\Letter\LetterEdit;
use Narmafzam\ArchiveBundle\ViewModel\Back\Letter\LetterIndex;
use Narmafzam\ArchiveBundle\ViewModel\Back\Letter\LetterNew;
use Narmafzam\ArchiveBundle\ViewModel\Back\Letter\LetterShow;
...
{
    const ROUTE__LETTER_INDEX  = 'back_letter_index';
    const ROUTE__LETTER_SHOW   = 'back_letter_show';
    const ROUTE__LETTER_NEW    = 'back_letter_new';
    const ROUTE__LETTER_EDIT   = 'back_letter_edit';
    const ROUTE__LETTER_DELETE = 'back_letter_delete';

    /**
     * @Route("", name = Narmafzam\ArchiveBundle\Controller\Back\LetterController::ROUTE__LETTER_INDEX)
     * @Method("GET")
     */
     ...
     *
     * @Route("/new", name = Narmafzam\ArchiveBundle\Controller\Back\LetterController::ROUTE__LETTER_NEW)
     * @Method({"GET", "POST"})
     */
     ...
     * @return Response A Response instance
     *
     * @Route("/{id}/edit", name = Narmafzam\ArchiveBundle\Controller\Back\LetterController::ROUTE__LETTER_EDIT)
     * @Method({"GET", "POST"})
     */
    ...
    /**
     * @Route("/{id}", name = Narmafzam\ArchiveBundle\Controller\Back\LetterController::ROUTE__LETTER_DELETE)
     * @Method("DELETE")
     */
